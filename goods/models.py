...
#     is_root = models.BooleanField(default=False, verbose_name='是否是一级分类') 1级分类是热销机型
#     # image = models.ImageField(
#     #     upload_to='static/category/%Y/%m', verbose_name='分类图片', null=True, blank=True)
...
#     keywords = models.CharField(max_length=200, verbose_name='关键词')  #描述
#     # mongodb 存放产品id、
#     # image_id = models.CharField(max_length=500, verbose_name='产品图片' ,blank=True)  #存放mongodb的id
#     # barcode = models.CharField(max_length=100, verbose_name='条码')
#     price = models.DecimalField(
#         max_digits=8, decimal_places=2, verbose_name='售价')
#     # market_price = models.DecimalField(
#     #     max_digits=8, decimal_places=2, verbose_name='市场价')
#     cost_price = models.DecimalField(
#         max_digits=8, decimal_places=2, verbose_name='成本价')
#     count = models.IntegerField(default=0, verbose_name='库存')
#     # sales_count = models.IntegerField(default=0, verbose_name='售出数量')
#     is_show_sales_count = models.BooleanField(
#         default=False, verbose_name='显示销量')
#     # has_invoice = models.BooleanField(default=False, verbose_name='提供发票')
#     create_time = models.DateTimeField(verbose_name='创建时间', auto_now_add=True)
#     status = models.IntegerField(choices=STATUS_CHOICES, verbose_name='状态')  #(0, '下架')(1, '上架'),
