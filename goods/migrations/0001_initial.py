    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='static/category/%Y/%m', verbose_name='分类图片')),
                ('is_abort', models.BooleanField(default=False, verbose_name='是否删除')),
                ('parent', models.ForeignKey(blank=True, default=0, limit_choices_to={'is_abort': False, 'is_root': True}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='goods.Category', verbose_name='上级分类')),
            ],
            options={
                'verbose_name': '分类',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_abort', models.BooleanField(default=False, verbose_name='是否删除')),
                ('category', models.ForeignKey(blank=True, limit_choices_to={'is_abort': False}, null=True, on_delete=django.db.models.deletion.CASCADE, to='goods.Category', verbose_name='分类')),
            ],
            options={
                'verbose_name': '产品',
