...
class Order(models.Model):
    ...
    user = models.ForeignKey(UserProfile, verbose_name='客户', null=True,on_delete=models.CASCADE)
...
class PayRecord(models.Model):
    ...
    money = models.DecimalField(
        max_digits=8, decimal_places=2, verbose_name='交易金额')
    create_time = models.DateTimeField(auto_now_add=True, verbose_name='创建时间')
    ...
    pay_type = models.IntegerField(
        choices=((1, '微信支付'), (2, '支付宝支付'), (3, '余额支付')), verbose_name='支付方式')
    is_abort = models.BooleanField(default=False, verbose_name='是否删除')
